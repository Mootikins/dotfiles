...
map("n", "<C-Left>", "<Cmd>vertical resize -10<CR>", opts)
map("n", "<C-Right>", "<Cmd>vertical resize +10<CR>", opts)
map("n", "<C-Down>", "<Cmd>resize -10<CR>", opts)
map("n", "<C-Up>", "<Cmd>resize +10<CR>", opts)
