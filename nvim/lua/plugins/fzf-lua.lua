...
map('n', '<leader>fhe', "<Cmd>lua require('fzf-lua').help_tags()<CR>", opts)
map('n', '<leader>fc', "<Cmd>lua require('fzf-lua').git_bcommits()<CR>", opts)
map('n', '<leader>fac', "<Cmd>lua require('fzf-lua').git_commits()<CR>", opts)

map('n', '<leader>gf', "<Cmd>lua require('fzf-lua').grep_project()<CR>", opts)
map('n', '<leader>gl', "<Cmd>lua require('fzf-lua').live_grep_native()<CR>", opts)
